...
/**
 * SparkPostApiException - used when SparkPost API returns an exception.
 */
class SparkPostApiException extends Exception
{

    /**
     * {@inheritDoc}
     */
    protected $_messageTemplate = 'SparkPost API Error Message: %s (%s)';
}
